...
## 프로젝트 구성도
![TGW 프로젝트 구성도](./AWS_TGW.png)

## 프로젝트 목표:
1. AWS 기본 자원을 생성할 수 있다.
2. AWS Transit Gateway를 이용한 멀티리전 사설망을 구현할 수 있다.
3. AWS Site-to-Site를 이용한 하이브리드 사설망을 구현할 수 있다.
4. AWS Global Accelerator를 이용한 글로벌 서비스를 배포할 수 있다.
